...
export default function Footer({ homeRef, contactRef, aboutRef, servicesRef }: FooterProps) {
  ...
  const executeScrollHome = () => homeRef.current?.scrollIntoView({ behavior: "smooth", block: "center" });
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; 2024 Tomas Rinaldi Scatena. All rights reserved.
        </p>
      </div>
    </footer>
  );
